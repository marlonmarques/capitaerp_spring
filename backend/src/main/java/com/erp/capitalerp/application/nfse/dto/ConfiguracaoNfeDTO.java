...
public record ConfiguracaoNfeDTO(UUID id, UUID filialId, Boolean ativarNfe, Integer serie, Integer numeroNfe, UUID categoriaId,
    ...
    public ConfiguracaoNfeDTO(ConfiguracaoNfe c) {
        this(c.getId(), c.getFilialId(), c.getAtivarNfe(), c.getSerie(), c.getNumeroNfe(), c.getCategoriaId(),
